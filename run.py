...
env = constraint_wrapper(gym.make('Safexp-PointGoal1-v0'),cost_only=False,buckets=0,stack_obs=1,action_repeat=4)

sac_lagrange_pytorch(lambda: env, epochs=10, steps_per_epoch=6250, start_steps=2500,
